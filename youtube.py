...
#API key connection
def Api_connect():
  Api_Id="AIzaSyAyNSqA2j004cAb6d3PjuAFrYqM7UFGhso"
...
def get_videos_ids(channel_id):
  video_ids=[]
  response=youtube.channels().list(id="UC_x5XG1OV2P6uZZ5FSM9Ttw",part='contentDetails').execute()
...
client=pymongo.MongoClient("mongodb+srv://aravindvarmaesec:12345@cluster0.ljkas0r.mongodb.net/")
db=client["Youtube_data"]


def channel_details(channel_id):
    cha_details=get_channel_info(channel_id)
    pla_details=get_playlist_details(channel_id)
    vid_ids=get_videos_ids(channel_id)
    vid_details=get_video_info(vid_ids)
    com_details=get_comment_data(vid_ids)

    coll1=db["channel_details"]
    coll1.insert_one({"channel_information":cha_details,"playlist_information":pla_details,
...
def videos_table():
        ...
        for vi_data in coll1.find({},{"_id":0,"video_information":1}):
                for i in range (len(vi_data['video_information'])): 
                        vi_list.append(vi_data['video_information'][0])
...
def comments_table():
        ...
        for com_data in coll1.find({},{"_id":0,"comment_information":1}):
                for i in range (len(com_data['comment_information'])): 
                        com_list.append(com_data['comment_information'][0])
...
questions=st.selectbox("Select your question",("1.Names of all videos and their corresponding channel names",
                                               "2.Channels with highest number of videos and their counts",
                                               "3.Top ten most viewed videos and their channels",
                                               "4. Total number of comments with the video name",
                                               "5.Videos with high likes with their channel names",
                                               "6.Total number of likes with their corresponding video names",
                                               "7.Total number of views of each channels",
                                               "8.Names of the channels that have published videos in 2023",
                                               "9.Average duration of all videos with their channel names",
                                               "10.Videos with highest number of comments with their channel names"))


if questions =="1.Names of all videos and their corresponding channel names":
...
elif questions=="2.Channels with highest number of videos and their counts":
    query2='''select channel_name as channelname,videos_count as no_videos from channels order
                by videos_count desc'''
...
elif questions=="3.Top ten most viewed videos and their channels":
...
elif questions=="4. Total number of comments with the video name":
...
elif questions=="5.Videos with high likes with their channel names":
...
elif questions=="6.Total number of likes with their corresponding video names":
...
elif questions=="7.Total number of views of each channels":
...
elif questions=="8.Names of the channels that have published videos in 2023":
    query8='''select title as video_title, published_date as publisheddate, channel_name as channelname from videos
...
elif questions=="9.Average duration of all videos with their channel names":
...
elif questions=="10.Videos with highest number of comments with their channel names":
